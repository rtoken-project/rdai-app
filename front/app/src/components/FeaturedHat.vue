  ...
  <v-container
    ...
    <v-sheet
      ...
      <v-layout>
        <social
          :url="currentUrl"
          :title="'I am donating my interest to ' + interfaceHat.shortTitle"
...
export default {
  ...
  computed: {
    ...
    socialDescription(){
      return 'Using rDAI, you can donate the interest generated by your DAI to causes like ' + this.interfaceHat.title + '. Donate for free now!'
    }
  }
}
</script>
